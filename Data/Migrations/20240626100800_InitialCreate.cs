...
namespace Data.Migrations
{
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "reservations",
                columns: new[] { "Id", "CustomerName", "PlayTimeHours", "ReservationDate" },
                values: new object[] { 1, "John Doe", 2, new DateTime(2015, 11, 21, 0, 0, 0, 0, DateTimeKind.Unspecified) });

            migrationBuilder.InsertData(
                table: "reservations",
                columns: new[] { "Id", "CustomerName", "PlayTimeHours", "ReservationDate" },
                values: new object[] { 2, "Jane Smith", 3, new DateTime(2016, 11, 21, 0, 0, 0, 0, DateTimeKind.Unspecified) });
